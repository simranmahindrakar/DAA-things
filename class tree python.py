class Tree:
    ...
    def __init__(self,initval=None):
        self.value = initval
        if self.value: #if initval has a value
            self.left = Tree()  #create empty node
            self.right = Tree()
        else:
            self.left = None  #this is a node with all the fields None 
            self.right = None
        return
    ...
    #simple modification of the find algo
    def insert(self,v):
